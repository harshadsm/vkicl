...
public class ActualWeightUpdateAtOutwardServlet extends HttpServlet {
	...
	private Logger logger = Logger.getLogger(ActualWeightUpdateAtOutwardServlet.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String actualWeightStr = request.getParameter("actual_wt");
		String idStr = request.getParameter("warehouse_outward_id");
		String handledBy = request.getParameter("handledBy");
		Integer id = Integer.parseInt(idStr);
		WarehouseOutwardService service = new WarehouseOutwardService();
