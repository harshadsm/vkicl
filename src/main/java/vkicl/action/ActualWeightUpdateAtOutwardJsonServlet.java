...
public class ActualWeightUpdateAtOutwardJsonServlet extends HttpServlet {
	private static final long serialVersionUID = 48963374052419351L;

	private Logger logger = Logger.getLogger(ActualWeightUpdateAtOutwardJsonServlet.class);
