...
public class WarehouseOutwardUpdateActualWeightServlet extends HttpServlet {
	...
	private Logger logger = Logger.getLogger(WarehouseOutwardUpdateActualWeightServlet.class);
