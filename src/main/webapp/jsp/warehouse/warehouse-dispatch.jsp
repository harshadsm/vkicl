...
<script type="text/javascript">
	...
	function addRow() {
		var str = "<tr id='row-"+row_id+"' class='main-row'><input type='hidden' name='row' value='"+row_id+"'>"
				...
				+ "<td class='excel' colspan='1'><div class='input-group'><div class='input-group-btn weight-group'><input type='hidden' name='taxes' value='VAT 5%' /><button type='button' class='btn btn-default dropdown-toggle' data-toggle='dropdown' aria-expanded='false'>VAT 5% <span class='caret'></span></button><ul class='dropdown-menu dropdown-menu-right' role='menu'><li onclick='btnGroupChange(this);'><a>VAT 5%</a></li><li onclick='btnGroupChange(this);'><a>CST 2%</a></li><li onclick='btnGroupChange(this);'><a>CST 5%</a></li><li onclick='btnGroupChange(this);'><a>F-Form</a></li></ul></div></div></td>"
