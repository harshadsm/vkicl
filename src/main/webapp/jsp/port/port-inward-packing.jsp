...
function setText() {
		...
		/* $("input[name='thickness']:visible").attr("disabled", true);
		$("input[name='width']:visible").attr("disabled", true);
		$("input[name='length']:visible").attr("disabled", true);
		$("input[name='qty']:visible").attr("disabled", true);
		$("input[name='actualWt']:visible").attr("disabled", true); */
