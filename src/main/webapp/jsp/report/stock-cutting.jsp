...
<div class="row">
	<div class="col-md-8">
		<h3 class="page-head">Plate Details</h3>
	</div>
</div>
<div class="row">
<div>
...
$(function() {
	$("#grid").jqGrid(
		{
			url : './stockBalCuttingJsonServlet',
			datatype : 'json',
			mtype : 'GET',
			
			
			colNames : [ 'stockBalanceId', 'Mill Name', 'Type', 'Grade', 'Thickness', 'Width', 'Length','Quantity','Heat No','Plate No','Location','Is Rect?','Cut'],
